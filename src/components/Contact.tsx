    ...
    <section id="contato" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="bg-gradient-to-br from-blue-600 to-teal-500 rounded-2xl p-6 md:p-8 text-white text-center">
            <h3 className="text-xl md:text-2xl font-bold mb-6">Agende sua Sessão</h3>
            ...
            <div className="space-y-4">
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-green-600 hover:bg-green-700 text-white px-6 md:px-8 py-3 md:py-4 rounded-lg font-semibold text-base md:text-lg transition-all duration-300 flex items-center justify-center space-x-2 hover-scale w-full"
              >
                <MessageSquare size={20} className="md:w-6 md:h-6" />
                <span className="text-sm md:text-base">Agende sua sessão agora no WhatsApp</span>
              </a>
              
              <a 
                href="tel:+5512997405005" 
                className="bg-white/20 hover:bg-white/30 text-white px-6 md:px-8 py-3 md:py-4 rounded-lg font-semibold transition-all duration-300 flex items-center justify-center space-x-2 w-full"
              >
                <Phone size={20} className="md:w-6 md:h-6" />
                <span className="text-sm md:text-base">Ligar Agora</span>
              </a>
            </div>
